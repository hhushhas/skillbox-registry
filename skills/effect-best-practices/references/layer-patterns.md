...
Declare business dependencies in the `dependencies` array of `Effect.Service`. This improves composition and avoids "leaked dependencies" that require manual wiring at usage sites.
