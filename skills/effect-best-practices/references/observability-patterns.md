...
Prefer Effect.log instead of console.log in service and app code. Effect.log provides:
- Structured data
- Log levels
...
Prefer Effect.fn for service methods. It creates spans with useful names:
...
Prefer Config instead of direct process.env reads in service code:
